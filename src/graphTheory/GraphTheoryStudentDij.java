...
public class GraphTheoryStudentDij extends JFrame implements GraphAlgorithmListener {
    ...
    public GraphTheoryStudentDij() {
        ...
        newButton.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        ...
                        if (graph.getSize()>0) {
                            response = JOptionPane.showConfirmDialog(GraphTheoryStudentDij.this, "Are you sure that you wish to delete this graph\n"+
                                    "and start over?","New Graph",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.WARNING_MESSAGE);
                        }
                        if (response != JOptionPane.YES_OPTION)
                            return;
                        String newName = JOptionPane.showInputDialog(GraphTheoryStudentDij.this,"What is the name of the new Graph?","Name of Graph",
                                JOptionPane.QUESTION_MESSAGE);
                        graph = new Graph(newName);
                        GraphTheoryStudentDij.this.setTitle("Graph Creator - "+newName);
                        response = JOptionPane.showConfirmDialog(GraphTheoryStudentDij.this, "Will the new graph be weighted?",
        ...
        addVertexButton.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        String name = JOptionPane.showInputDialog(GraphTheoryStudentDij.this,"What is the name of the vertex to be added?",
        ...
        addEdgeButton.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        String name1 = JOptionPane.showInputDialog(GraphTheoryStudentDij.this,"What is the name of the first vertex for this edge?",
                                "Vertex Name",JOptionPane.QUESTION_MESSAGE);
                        String name2 = JOptionPane.showInputDialog(GraphTheoryStudentDij.this,"What is the name of the second vertex for this edge?",
                                "Vertex Name",JOptionPane.QUESTION_MESSAGE);
                        if (!isWeighted) {
                            graph.addEdge(new Vertex(name1), new Vertex(name2));
                        }
                        else {
                            float weight = Float.parseFloat(JOptionPane.showInputDialog(GraphTheoryStudentDij.this,"What is the weight of the edge?",
                                "Vertex Name",JOptionPane.QUESTION_MESSAGE));
        ...
        showGraphButton.addActionListener(
                new ActionListener() {
                   public void actionPerformed(ActionEvent e) {
                       JOptionPane.showMessageDialog(GraphTheoryStudentDij.this, graph, "Graph Listing",JOptionPane.PLAIN_MESSAGE);
                   } 
                });
                ...
                new ActionListener() {
                   public void actionPerformed(ActionEvent e) {
                      try {
                           ...
                           int option = chooser.showSaveDialog(GraphTheoryStudentDij.this);
                           if (option==JFileChooser.APPROVE_OPTION) {
                               new ObjectOutputStream(new FileOutputStream(chooser.getSelectedFile())).writeObject(graph);
                           }
                       }
                       catch(Exception ex) {
                           JOptionPane.showMessageDialog(GraphTheoryStudentDij.this,"Save Failed","Save Failed",JOptionPane.ERROR_MESSAGE);
                           return;
                       }
                   } 
                });
        ...
        loadGraphButton.addActionListener(
                new ActionListener() {
                   public void actionPerformed(ActionEvent e) {
                       try {
                           JFileChooser chooser = new JFileChooser();
                           int option = chooser.showOpenDialog(GraphTheoryStudentDij.this);
                           if (option==JFileChooser.APPROVE_OPTION) {
                       ...
                       GraphTheoryStudentDij.this.setTitle("Graph Creator - "+graph.getName());
        ...
        depthFirstItem.addActionListener(new ActionListener() {
           public void actionPerformed(ActionEvent e) {
               ...
               if (start!=null) {
                    ...
                    JOptionPane.showMessageDialog(GraphTheoryStudentDij.this,output,
                            "Path Found",JOptionPane.INFORMATION_MESSAGE);
               }
               else
                   JOptionPane.showMessageDialog(GraphTheoryStudentDij.this,
    ...
    public void nodeVisited(NodeEvent e) {
        if (e.getParent() == null) {
            JOptionPane.showMessageDialog(GraphTheoryStudentDij.this,"Algorithm Started\n"+
        ...
        revisualize(false);
        JOptionPane.showMessageDialog(GraphTheoryStudentDij.this, e.visitedNode.name+" removed");
    }
    ...
    protected void revisualize(boolean recompute) {
        ...
        GraphTheoryStudentDij.this.pane.setRightComponent(rightPanel);
    }
    ...
    class VisualizationPanel extends JPanel implements MouseMotionListener, MouseListener {
        ...
        public void mouseReleased(MouseEvent e) {
            ...
            if (!e.isPopupTrigger() && dragging!=null) {
                ...
                GraphTheoryStudentDij.this.revisualize(false);
            }
            //popup menu
                ...
                for(PositionedVertex pv:vertexLocations) {
                    if (x>=pv.x-5 && x<=pv.x+5 && y>=pv.y-5 && y<=pv.y+5) {
                        lastSelected = pv;
                        visualizePopup.show(GraphTheoryStudentDij.this,pv.x+230,pv.y+65);
                        return;
                    }
                }
            }
